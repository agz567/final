...
var base = Rebase.createClass({
  apiKey: "AIzaSyBl0MAU_XoPcz4876cyUQJxrZfYrqYfk7o",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-final-33b40.firebaseio.com/", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  getInitialState: function() {
    return {
      movies: movieData.sort(this.movieCompareByRelease),
      currentMovie: null
    }
  },
